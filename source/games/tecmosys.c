...
static struct ROM_INFO rom_shadoww[] =
{
  ...
  LOAD( GFX2, "15.bin", 0x020000, 0x20000, 0x1291a696),
  LOAD( GFX2, "16.bin", 0x040000, 0x20000, 0x140b47ca),
  LOAD( GFX2, "17.bin", 0x060000, 0x20000, 0x7638cccb),
  LOAD( GFX3, "18.bin", 0x000000, 0x20000, 0x3fadafd6),
  LOAD( GFX3, "19.bin", 0x020000, 0x20000, 0xddae9d5b),
  LOAD( GFX3, "20.bin", 0x040000, 0x20000, 0x08cf7a93),
  LOAD( GFX3, "21.bin", 0x060000, 0x20000, 0x1ac892f5),
  LOAD( GFX4, "gaiden.6", 0x000000, 0x20000, 0xe7ccdf9f),
  LOAD( GFX4, "gaiden.8", 0x020000, 0x20000, 0x7ef7f880),
  LOAD( GFX4, "gaiden.10", 0x040000, 0x20000, 0xa6451dec),
  LOAD( GFX4, "shadoww.12a", 0x060000, 0x10000, 0x9bb07731),
  LOAD( GFX4, "shadoww.12b", 0x070000, 0x10000, 0xa4a950a2),
  LOAD( GFX4, "gaiden.7", 0x080000, 0x20000, 0x016bec95),
  LOAD( GFX4, "gaiden.9", 0x0a0000, 0x20000, 0x6e9b7fd3),
  LOAD( GFX4, "gaiden.11", 0x0c0000, 0x20000, 0x7fbfdf5e),
  LOAD( GFX4, "shadoww.13a", 0x0e0000, 0x10000, 0x996d2fa5),
  LOAD( GFX4, "shadoww.13b", 0x0f0000, 0x10000, 0xb8df8a34),
  LOAD( SMP1, "gaiden.4", 0x0000, 0x20000, 0xb0e0faf9),
  { NULL, 0, 0, 0, 0, 0 }
};
...
static struct ROM_INFO rom_gaiden[] =
{
  ...
  LOAD( GFX4, "gaiden.8", 0x020000, 0x20000, 0x7ef7f880),
  LOAD( GFX4, "gaiden.10", 0x040000, 0x20000, 0xa6451dec),
  LOAD( GFX4, "gaiden.12", 0x060000, 0x20000, 0x90f1e13a),
  LOAD( GFX4, "gaiden.7", 0x080000, 0x20000, 0x016bec95),
  LOAD( GFX4, "gaiden.9", 0x0a0000, 0x20000, 0x6e9b7fd3),
  LOAD( GFX4, "gaiden.11", 0x0c0000, 0x20000, 0x7fbfdf5e),
  LOAD( GFX4, "gaiden.13", 0x0e0000, 0x20000, 0x7d9f5c5e),
  LOAD( SMP1, "gaiden.4", 0x0000, 0x20000, 0xb0e0faf9),
  { NULL, 0, 0, 0, 0, 0 }
};
...
static struct ROM_INFO rom_ryukendn[] =
{
  ...
  LOAD( GFX4, "gaiden.10", 0x040000, 0x20000, 0xa6451dec),
  LOAD( GFX4, "shadoww.12a", 0x060000, 0x10000, 0x9bb07731),
  LOAD( GFX4, "ryukendn.12b", 0x070000, 0x10000, 0x1773628a),
  LOAD( GFX4, "gaiden.7", 0x080000, 0x20000, 0x016bec95),
  LOAD( GFX4, "ryukendn.9a", 0x0a0000, 0x10000, 0xc821e200),
  LOAD( GFX4, "ryukendn.9b", 0x0b0000, 0x10000, 0x6a6233b3),
  LOAD( GFX4, "gaiden.11", 0x0c0000, 0x20000, 0x7fbfdf5e),
  LOAD( GFX4, "shadoww.13a", 0x0e0000, 0x10000, 0x996d2fa5),
  LOAD( GFX4, "ryukendn.13b", 0x0f0000, 0x10000, 0x1f43c507),
  LOAD( SMP1, "gaiden.4", 0x0000, 0x20000, 0xb0e0faf9),
  { NULL, 0, 0, 0, 0, 0 }
};
...
static struct ROM_INFO rom_tknight[] =
{
  ...
  LOAD( GFX3, "tkni6.bin", 0x000000, 0x80000, 0xf68fafb1),
  LOAD( GFX4, "tkni9.bin", 0x000000, 0x80000, 0xd22f4239),
  LOAD( GFX4, "tkni8.bin", 0x080000, 0x80000, 0x4931b184),
  LOAD( SMP1, "tkni4.bin", 0x0000, 0x20000, 0xa7a1dbcf),
  { NULL, 0, 0, 0, 0, 0 }
};
...
static struct ROM_INFO rom_wildfang[] =
{
  ...
  LOAD( GFX2, "15.3b", 0x020000, 0x20000, 0x3f40a6b4),
  LOAD( GFX2, "16.1a", 0x040000, 0x20000, 0x0f31639e),
  LOAD( GFX2, "17.1b", 0x060000, 0x20000, 0xf32c158e),
  LOAD( GFX3, "tkni6.bin", 0x000000, 0x80000, 0xf68fafb1),
  LOAD( GFX4, "tkni9.bin", 0x000000, 0x80000, 0xd22f4239),
  LOAD( GFX4, "tkni8.bin", 0x080000, 0x80000, 0x4931b184),
  LOAD( SMP1, "tkni4.bin", 0x0000, 0x20000, 0xa7a1dbcf),
...
static struct ROM_INFO stratof_roms[] =
{
  ...
  LOAD( GFX2, "b-1b", 0x00000, 0x80000, 0x781d1bd2),
  LOAD( GFX3, "b-4b", 0x00000, 0x80000, 0x89468b84),
  LOAD( GFX4, "b-2m", 0x00000, 0x80000, 0x5794ec32),
  LOAD( GFX4, "b-1m", 0x80000, 0x80000, 0xb0de0ded),
  LOAD( SMP1, "a-4a.4", 0x00000, 0x20000, 0xef9acdcf),
  { NULL, 0, 0, 0, 0, 0 }
};
