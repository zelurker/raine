...
static struct ROM_INFO rom_gunlock[] =
{
  ...
  LOAD8_16( ROM2, "d66-23.rom", 0x000000, 0x00040000, 0x57fb7c49),
  LOAD8_16( ROM2, "d66-22.rom", 0x000000+1, 0x00040000, 0x83dd7f9b),
...
CLNE( rayforcj, gunlock,"Ray Force (Japan)", TAITO, 1993, GAME_SHOOT,
	.long_name_jpn = "ﾂδ個イﾂフﾂォﾂーﾂス (Japan)",
);
