...
//   { "Upright/Steering Lock", 0x03, 0x00 },
//   { "Upright No Steer Lock",  0x02, 0x00 },
   { "Full Throttle Convrt",  0x01, 0x00 },
//   { "Full Thrtle Dlx Cnvrt", 0x00, 0x00 },
...
{
   { "Gear Mode",             0x01, 0x02 },
   { "Low while pressed",     0x01, 0x00 },
   { "Toggle",                0x00, 0x00 },
#ifndef SDL
   { "Wheel",                 0x02, 0x02 },
   { "Keyboard/Digital",      0x02, 0x00 },
   { "PC Steering Wheel",     0x00, 0x00 },
   { "Accelerator",           0x04, 0x02 },
   { "Keyboard/Digital",      0x04, 0x00 },
   { "PC Pedal (analog)",     0x00, 0x00 },
   { "Brake",                 0x08, 0x02 },
   { "Keyboard/Digital",      0x08, 0x00 },
   { "PC Pedal (analog)",     0x00, 0x00 },
#endif
   { NULL,                    0,    0,   },
};
