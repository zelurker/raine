...
CLNE(majest12j, ssi, "Majestic Twelve", TAITO, 1990, GAME_SHOOT,
	.long_name_jpn = "�}�W�F�X�e�B�b�N�g�E�F���u",
	.board = "C64",
);
...
GME( ssi, "Super Space Invaders 91", TAITO, 1990, GAME_SHOOT,
	.romsw = romsw_ssi,
	.long_name_jpn = "�X�[�p�[�X�y�[�X�C���x�[�_�[�f�X�P",
	.board = "C64",
);
