...
{
  { "asuka_13.rom", 0x20000, 0x855efb3e, REGION_ROM1, 0x00000, LOAD_8_16 },
	/* 0x040000 - 0x7ffff is intentionally empty */
  { "asuka_12.rom", 0x20000, 0x271eeee9, REGION_ROM1, 0x00001, LOAD_8_16 },
  ...
  { "asuka_07.rom", 0x10000, 0xc113acc8, REGION_GFX2, 0x80000, LOAD_8_16 },
  { "asuka_06.rom", 0x10000, 0xf517e64d, REGION_GFX2, 0x80001, LOAD_8_16 },
...
static struct DSW_DATA dsw_data_asuka_and_asuka_1[] =
{
   ...
   { "Up to Level 2",         0xC0, 0x00 },
   { "Up to Level 3",         0x80, 0x00 },
   { MSG_ON,                  0x40, 0x00 },
   { MSG_OFF,                 0x00, 0x00 },
   { NULL,                    0,    0,   },
};
