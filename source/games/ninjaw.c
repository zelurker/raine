...
static struct ROM_INFO rom_ninjaw[] =
{
  ...
  LOAD( SMP1, "b31-09.18", 0x000000, 0x80000, 0x60a73382),
  LOAD( SMP1, "b31-10.17", 0x080000, 0x80000, 0xc6434aef),
  LOAD( SMP1, "b31-11.16", 0x100000, 0x80000, 0x8da531d4),
  LOAD( SMP2, "b31-08.19", 0x000000, 0x80000, 0xa0a1f87d),
   {           NULL,          0,          0, 0, 0, 0, },
};
...
static struct ROM_INFO rom_darius2[] =
{
  ...
  LOAD( SMP1, "c07-10.95", 0x00000, 0x80000, 0x4bbe0ed9),
  LOAD( SMP1, "c07-11.96", 0x80000, 0x80000, 0x3c815699),
  LOAD( SMP2, "c07-12.107", 0x00000, 0x80000, 0xe0b71258),
