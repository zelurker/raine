...
static struct ROM_INFO rom_bshark[] =
{
  ...
  LOAD8_16( ROM1, "c34_71.98", 0x00000, 0x20000, 0xdf1fa629),
  LOAD8_16( ROM1, "c34_69.75", 0x00000+1, 0x20000, 0xa54c137a),

  LOAD8_16( ROM1, "c34_70.97", 0x40000, 0x20000, 0xd77d81e2),
  LOAD8_16( ROM1, "bshark67.bin", 0x40000+1, 0x20000, 0x39307c74),

  LOAD8_16( ROM2, "c34_74.128", 0x00000, 0x20000, 0x6869fa99),
  LOAD8_16( ROM2, "c34_72.112", 0x00000+1, 0x20000, 0xc09c0f91),

  LOAD8_16( ROM2, "c34_75.129", 0x40000, 0x20000, 0x6ba65542),
  LOAD8_16( ROM2, "c34_73.113", 0x40000+1, 0x20000, 0xf2fe62b5),
  LOAD( GFX1, "c34_05.3", 0x00000, 0x80000, 0x596b83da),
  ...
  LOAD( GFX3, "c34_07.42", 0x00000, 0x80000, 0xedb07808),
  LOAD( USER1, "c34_06.12", 0x00000, 0x80000, 0xd200b6eb),
  LOAD( SMP1, "c34_08.127", 0x00000, 0x80000, 0x89a30450),
  LOAD( SMP2, "c34_09.126", 0x00000, 0x80000, 0x39d12b50),
   {           NULL,          0,          0, 0, 0, 0, },
};
