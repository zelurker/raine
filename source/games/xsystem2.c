...
static struct DSW_DATA dsw_data_insector_x_0[] =
{
   ...
   { MSG_NORMAL,              0x00, 0x00 },	// r180, invert is default?
...
static struct DSW_DATA dsw_data_extermination_1[] =
{
   ...
   { MSG_NORMAL,              0x80, 0x00 },	// when hit by monsters. It might not be
   { MSG_EASY,                0xC0, 0x00 },	// the actual game difficulty setting.
   { MSG_HARD,                0x40, 0x00 },
   { MSG_HARDEST,             0x00, 0x00 },
   { NULL,                    0,    0,   },
};
