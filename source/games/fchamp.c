...
static struct DSW_DATA dsw_data_football_champ_1[] =
{
   ...
   { "Game Type",             0x30, 0x04 },
   { "2 Players",             0x30},
   { "4 Player/4 Coin Slot",  0x20},
   { "4 Player/2 Cabinets",   0x10},
   { "4 Player/2 Coin Slot",  0x00},
   { "Continue",              0x40, 0x02 },
   { MSG_OFF,                 0x40},
   { MSG_ON,                  0x00},
...
static struct DSW_DATA dsw_data_hat_trick_hero_0[] =
{
   ...
   { "Both Teams",            0x80}, //  let's reverse the byte order but
   { "Loser Team Only",       0x00}, //  keep the visual look the same as
...
static struct DSW_DATA dsw_data_hat_trick_hero_1[] =
{
   ...
   { "Game Type",             0x0c, 0x04 },
   { "2 Players",             0x0c},
   { "4 Player/4 Coin Slot",  0x04},
   { "4 Player/2 Cabinets",   0x08},
   { "4 Player/2 Coin Slot",  0x00},
   { "Continue",              0x02, 0x02 },
   { MSG_OFF,                 0x02},
   { MSG_ON,                  0x00},
