...
static struct ROM_INFO rom_macrossp[] =
{
  ...
  LOAD( GFX2, "bp964a.u13", 0x000000, 0x400000, 0xf4d3c5bf ),
  LOAD( GFX2, "bp964a.u14", 0x400000, 0x400000, 0x4f2dd1b2 ),

  LOAD( GFX3, "bp964a.u15", 0x000000, 0x400000, 0x5b97a870 ),
  LOAD( GFX3, "bp964a.u16", 0x400000, 0x400000, 0xc8a0cd64 ),

  LOAD( GFX4, "bp964a.u17", 0x000000, 0x400000, 0xf2470876 ),
  LOAD( GFX4, "bp964a.u18", 0x400000, 0x400000, 0x52ef21f3 ),
...
static struct ROM_INFO quizmoon_roms[] =
{
  ...
  LOAD( ROM2, "u20.bin", 0x000000, 0x020000, 0xd7ad1ffb ),
  LOAD( ROM2, "u21.bin", 0x000000, 0x020000, 0x6fc625c6 ),

  LOAD( ROM2, "u49.bin", 0x000000, 0x020000, 0x1590ad81 ),
  ...
  LOAD( GFX2, "u13.bin", 0x0000000, 0x0400000, 0x3dcbb041 ),

  LOAD( GFX3, "u15.bin", 0x0000000, 0x0400000, 0xb84224f0 ),

  LOAD( GFX4, "u17.bin", 0x0000000, 0x0200000, 0xff93c949 ),

  LOAD( SMP1, "u24.bin", 0x0000000, 0x0400000, 0x5b12d0b1 ),
  LOAD( SMP1, "u25.bin", 0x0400000, 0x0400000, 0x3b9689bc ),
  LOAD( SMP1, "u26.bin", 0x0800000, 0x0400000, 0x6c8f30d4 ),
  LOAD( SMP1, "u27.bin", 0x0c00000, 0x0400000, 0xbd75d165 ),
  { NULL, 0, 0, 0, 0, 0 }
};
