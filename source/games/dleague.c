...
{
  LOAD_16_8( ROM1, "c02-19a.33", 0x000000, 0x00020000, 0x7e904e45),
  LOAD_16_8( ROM1, "c02-21a.36", 0x000001, 0x00020000, 0x18c8a32b),
  LOAD_16_8( ROM1, "c02-20.34", 0x040000, 0x00010000, 0xcdf593f3),
  LOAD_16_8( ROM1, "c02-22.37", 0x040001, 0x00010000, 0xf50db2d7),

  LOAD( ROM2, "c02-23.40", 0x000000, 0x00010000, 0x5632ee49),

  LOAD( GFX1, "c02-02.15", 0x000000, 0x00080000, 0xb273f854),
  LOAD_16_8( GFX1, "c02-06.6", 0x080000, 0x00020000, 0xb8473c7b),
  LOAD_16_8( GFX1, "c02-10.14", 0x080001, 0x00020000, 0x50c02f0f),

  LOAD( GFX1, "c02-03.17", 0x100000, 0x00080000, 0xc3fd0dcd),
  LOAD_16_8( GFX1, "c02-07.7", 0x180000, 0x00020000, 0x8c1e3296),
  LOAD_16_8( GFX1, "c02-11.16", 0x180001, 0x00020000, 0xfbe548b8),

  LOAD( GFX1, "c02-24.19", 0x200000, 0x00080000, 0x18ef740a),
  LOAD_16_8( GFX1, "c02-08.8", 0x280000, 0x00020000, 0x1a3c2f93),
  LOAD_16_8( GFX1, "c02-12.18", 0x280001, 0x00020000, 0xb1c151c5),

  LOAD( GFX1, "c02-05.21", 0x300000, 0x00080000, 0xfe3a5179),
  LOAD_16_8( GFX1, "c02-09.9", 0x380000, 0x00020000, 0xa614d234),
  LOAD_16_8( GFX1, "c02-13.20", 0x380001, 0x00020000, 0x8eb3194d),
  FILL( GFX1, 0x3c0000, 0x40000, 0),

  LOAD( GFX2, "c02-18.22", 0x000000, 0x00002000, 0xc88f0bbe),

  LOAD( SMP1, "c02-01.31", 0x00000, 0x00080000, 0xd5a3d1aa),
