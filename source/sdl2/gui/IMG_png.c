// since sdl_image uses stb by default to load png files which doesn't handle palette images,
// I need to include now the libpng version here to get back palette support !!!
// What a shame... !
/*
