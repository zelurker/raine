/* This is directly taken from sdl2 test directory, adapted... */
/*
...
LoadTexture(SDL_Renderer *renderer, const char *file, SDL_bool transparent)
{
    ...
    snprintf(file2,FILENAME_MAX,"bitmaps/%s",file);
    char *s = get_shared(file2);
    temp = SDL_LoadBMP(s);
    if (temp == NULL) {
...
WatchJoystick(SDL_Joystick * joystick)
{
    ...
    mapping[0] = 0; // in case the mapping isn't complete
