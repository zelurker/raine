...
{                                                                                                                            \
    ...
    INT16 xx,yy,dx;                                                                                                          \
    for(yy=0; yy<(SIZE); yy++){                                                                                              \
        if (y+yy < border-SIZE || y+yy > maxy) {                                                                             \
            SPR += SIZE;                                                                                                     \
            continue;                                                                                                        \
        }                                                                                                                    \
        dx = x+dy[yy];                                                                                                       \
        if (dx < border-SIZE || dx > maxx) {                                                                                 \
            SPR += (SIZE);                                                                                                   \
            continue;                                                                                                        \
        }                                                                                                                    \
...
void init_pldraw() {
    ...
    maxx = current_game->video->screen_x + border;
    maxy = current_game->video->screen_y + border;
}
